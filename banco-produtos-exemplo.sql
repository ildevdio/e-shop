...
-- preco_atacado, estoque_fiscal_sefaz, a_granel
--
-- CAS001/CHI001/AVE001 já existem no cadastro (atualizam em vez
-- de duplicar). Os demais serão criados.
-- ============================================================

INSERT INTO tb_produtos_crm (codigo_erp, nome, unidade_venda, peso_unidade, ativo, unidades_por_caixa, preco_varejo, preco_atacado, estoque_fiscal_sefaz, a_granel) VALUES
    ('CAS001', 'Castanha do Pará', 'kg', 0.5, true, 12, 45.90, 42.50, 320.500, true),
    ('CHI001', 'Chia (1kg)', 'kg', 1, true, 24, 25.90, 23.00, 150.000, true),
    ('AVE001', 'Aveia em Flocos', 'kg', 0.5, true, 12, 12.90, 11.20, 85.250, true),
    ('AMEND001', 'Amendoim Torrado Salgado', 'kg', 0.25, true, 20, 9.90, 8.50, 60.000, true),
    ('TEM001', 'Tempero Baiano', 'g', 0.1, true, 30, 7.50, 6.30, 45.000, true),
    ('PAO001', 'Pão de Mel Recheado', 'un', 0.08, true, 40, 3.90, 3.20, 120.000, false);
