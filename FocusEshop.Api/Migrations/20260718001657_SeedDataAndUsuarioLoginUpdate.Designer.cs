...
namespace Multigrao.Api.Migrations
{
    ...
    [Migration("20260718001657_SeedDataAndUsuarioLoginUpdate")]
    partial class SeedDataAndUsuarioLoginUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Multigrao.Api.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = "AdminMaster",
                            SenhaHash = "$2a$11$n.NPXBGoATdtu.nH.p3i1OcHYRXFm/NGGVGzXy0YT3KKipUj4E.we",
                            UsuarioLogin = "admin"
                        },
                        new
                        {
